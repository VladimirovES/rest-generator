...
from src.my_codegen.codegen.django_generator import generate_django_code
...
def main():
    ...
    # 4. Если передан флаг --django, используем Django-генератор
    if args.django:
        logger.info("Django mode enabled. Generating Django-specific code...")
