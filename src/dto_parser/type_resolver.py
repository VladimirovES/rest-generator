...
class TypeResolver:
    ...
    def _handle_composition(
        self, schemas: List[Dict], composition_type: str, name_hint: str
    ) -> str:
    ...
    def get_imports(self) -> List[str]:
        ...
        typing_imports = [
            ...
            if imp in ["List", "Dict", "Any", "Optional", "Union"]
        ]
        if typing_imports:
            import_lines.append(
        ...
        pydantic_imports = [
            imp for imp in self.imports if imp in ["EmailStr", "AnyUrl", "BaseModel"]
        ]
        if pydantic_imports:
            import_lines.append(
